...
SELECT E1_FILIAL AS EMPRESA,RTRIM(M0_NOME) AS NOMEEMP,RTRIM(E1_NUM) AS NUMERO, RTRIM(E1_TIPO) AS TIPO,RTRIM(E1_PREFIXO) AS SERIE,E1_VALOR AS VALOR,E1_SALDO AS SALDO, RTRIM(E1_CODBAR) CODBARRAS,RTRIM(E1_CODDIG) AS LINDIG,RTRIM(E1_NUMBCO) AS NUMBCO,RTRIM(E1_NUMBOR) AS BORDERO,
