...
CASE E1_TIPO WHEN 'BOL'  THEN 'Boleto' WHEN 'FT' THEN 'Faturado' WHEN 'NP' THEN 'Nota Promissória' WHEN 'REN' THEN 'Renegociação'
 WHEN 'DP' THEN 'Depósito' WHEN 'CC' THEN 'Cartão de Crédito' WHEN 'CD' THEN 'Cartão de Débito' WHEN 'PX' THEN 'Pix' WHEN 'CH' THEN 'Cheque'
...
WHERE E1_TIPO IN ('BOL','NP','REN','DP','CC','CD','FT','PX','CH')